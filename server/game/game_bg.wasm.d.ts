...
export function wasm_bindgen__convert__closures__invoke1_mut__h091f975372d59725(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h9588852e23e0cc35(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd01ddde97f9d051f(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6a8439092d38e70f(a: number, b: number): void;
